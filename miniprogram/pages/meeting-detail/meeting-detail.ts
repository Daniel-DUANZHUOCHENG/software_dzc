...
Page({
  ...
  // 到达方式改变
  onArrivalMethodChange(e: WechatMiniprogram.CustomEvent) {
    this.setData({
  ...
  // 到达时间改变
  onArrivalTimeChange(e: WechatMiniprogram.CustomEvent) {
    this.setData({
