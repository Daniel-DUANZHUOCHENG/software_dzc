...
public class AiService {
    ...
    public Map<String, Object> parseTextForUserForm(String text) {
        ...
        systemMessage.put("content", "You are a helpful assistant that extracts user information from natural language and returns it as a JSON object.");
                ...
                if (!choices.isEmpty()) {
                    ...
                    if (firstChoice.containsKey("message")) {
                        ...
                        if (message.containsKey("content")) {
                            ...
                            try {
                                 Map<String, Object> extractedData = gson.fromJson(content, new TypeToken<Map<String, Object>>() {}.getType());
                                 return extractedData;
                            } catch (JsonSyntaxException e) {
                                System.err.println("AI returned invalid JSON format: " + content);
    ...
    private String buildPrompt(String userInput) {
        return "You are an efficient OA system assistant. Your task is to extract information from the user's natural language description and return it in a strict JSON format for filling out the 'Create User' form.\n\n" +
                ...
                "  \"role\": \"String, the user's job position.\",\n" +
